        ...
        ************   Navigation / Router   ************
        ...
        app.router = {
            ...
            animatePages: function (leftPage, rightPage, direction, view) {
                ...
                if (direction === 'to-left') {
                    leftPage.removeClass(removeClasses).addClass('pt-page-rotateFall');
        ...
        app.router._load = function (view, options) {
            ...
            function afterAnimation() {
                ...
                oldPage.removeClass('pt-page-rotateFall page-on-center page-on-right').addClass('page-on-left');
                if (dynamicNavbar) {
